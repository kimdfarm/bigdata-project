...
rs = ollama.chat(
    model = "gemma3:4b",
        messages = [{"role" : "system" , "content":"주어진 텍스트에서 핵심 키워드 7개를 추출하세요. 키워드만 쉼표로 구분하여 나열하세요"},
        {"role":"user" , "content":article}
        ]
)
print(rs["message"]["content"])

print("\n===키워드 추출===")
rse = ollama.chat(
    model = "gemma3:4b",
    messages = [
        {"role":"system","content":"주어진 텍스트를 정확히 2줄로 요약하세요. 각 줄은 한 문장으로 작성하세요"},
        {"role":"user","content":article}
