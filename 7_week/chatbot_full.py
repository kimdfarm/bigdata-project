...
with st.sidebar:
    ...
    # 시스템 프롬프트 선택
    system_prompts = {
        "S": "당신은 S (Situation): AI의 역할 설정이야 한국어로 답변해주세요.",
        "T": "당신은 T (Task): 수행할 작업 정의이야 작업 정의 눈높이에 맞춰 쉽게 설명하고, 코드 예시를 포함해주세요.",
        "A": "당신은 A (Action): 지켜야 할 규칙입니다. Pandas, 시각화, 통계 분석에 대해 전문적으로 답변해주세요.",
        "R": "당신은 R (Result): 출력 형식입니다. 사용자가 한국어로 질문하면 영어로 답변하고, 한국어 해설을 아래에 추가해주세요.",
    }
